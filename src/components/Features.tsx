  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10 max-w-7xl flex flex-col items-center">
          ...
          {features.map((feature, featureIndex) => {
            ...
            return (
              <div
                key={featureIndex}
                className={`
                  cursor-pointer rounded-xl p-4 sm:p-6 backdrop-blur-sm transition-transform duration-300 max-w-full
                  flex flex-col items-center justify-center w-full sm:w-auto
                  ${
                    blinkingNodeGlobalIndex >= startIndex &&
                    blinkingNodeGlobalIndex < startIndex + 4
                      ? theme === 'dark'
        ...
        {/* Explore Card */}
        <div
          className={`rounded-2xl p-6 sm:p-8 backdrop-blur-sm mt-12 sm:mt-16 max-w-xl sm:max-w-3xl mx-auto transform transition-all duration-700 ease-in-out ${
            expanded
